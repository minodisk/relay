(function() {
  var Actor, AnimationFrameTicker, Easing, EasingActor, FunctionActor, GroupActor, Junc, ParallelActor, RepeatActor, SerialActor, WaitActor, _PI, _PI_D, _PI_H, _abs, _asin, _cos, _pow, _requestAnimationFrame, _sin, _slice, _sqrt,
  ...
  EasingActor = (function(_super) {
    ...
    function EasingActor(target, src, dst, duration, easing) {
      ...
      if ((typeof window !== "undefined" && window !== null) && target instanceof window.HTMLElement) {
        ...
        this.object = this._getStyle(target);
      } else {
    ...
    EasingActor.prototype.clone = function() {
      var actor;
      actor = new EasingActor(null, this.src, this.dst, this.duration, this.easing);
      actor.target = this.target;
      return actor.object = this.object;
    };
    ...
    EasingActor.prototype.stop = function() {
      EasingActor.__super__.stop.call(this);
    };
    ...
    EasingActor.prototype._getStyle = function(element) {
