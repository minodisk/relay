(function() {
  var Actor, AnimationFrameTicker, EachActor, Easing, EasingActor, FunctionActor, GroupActor, Junc, ParallelActor, ParallelEachActor, RepeatActor, SerialActor, WaitActor, _PI, _PI_D, _PI_H, _abs, _asin, _cos, _isArray, _pow, _requestAnimationFrame, _sin, _slice, _sqrt,
  ...
  ParallelActor = (function(_super) {
    ...
    ParallelActor.prototype._act = function(args) {
      ...
      for (i = 0, _len = _ref.length; i < _len; i++) {
        ...
        if (this.local.index < this.local.length) {
          ParallelActor.__super__._act.call(this, actor, args);
        }
      }
    };
  ...
  EachActor = (function(_super) {
    ...
    EachActor.prototype._act = GroupActor.prototype._act;
  ...
  ParallelEachActor = (function(_super) {
    ...
    function ParallelEachActor() {
      this.next = __bind(this.next, this);
      ParallelEachActor.__super__.constructor.apply(this, arguments);
    }

    ParallelEachActor.prototype.clone = function() {
      return new ParallelEachActor(this.__actor);
    };

    ParallelEachActor.prototype.start = function(_args) {
      var arg, i, _len, _ref;
      this._args = _args;
      this._actors = [];
      _ref = this._args;
      for (i = 0, _len = _ref.length; i < _len; i++) {
        arg = _ref[i];
        this._actors[i] = this.__actor.clone();
      }
      ParallelEachActor.__super__.start.call(this);
      this._storage = [];
      if (this.local.index < this.local.length) {
        this._act.apply(this);
        this._onStart();
      }
      return this;
    };

    ParallelEachActor.prototype.next = function() {
      var args, i,
        _this = this;
      i = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      this._storage[i] = args;
    ...
    ParallelEachActor.prototype._act = function() {
      var actor, i, _len, _ref,
        _this = this;
      _ref = this._actors;
      for (i = 0, _len = _ref.length; i < _len; i++) {
        ...
        if (this.local.index < this.local.length) {
          ParallelEachActor.__super__._act.call(this, actor, [this._args[i]]);
        }
      }
    };
