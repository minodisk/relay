(function() {
  var Actor, AnimationFrameTicker, Easing, EasingActor, FunctionActor, GroupActor, ParallelActor, ParallelEachActor, Relay, SerialActor, SerialEachActor, WaitActor, relay, _PI, _PI_D, _PI_H, _abs, _asin, _cos, _indexOf, _isArray, _pow, _requestAnimationFrame, _sin, _slice, _sqrt, __bind = function(fn, me) {
    return function() {
  ...
  SerialEachActor = function(_super) {
    ...
    function SerialEachActor(actor) {
      this.next = __bind(this.next, this);
      SerialEachActor.__super__.constructor.call(this, [ actor ]);
    }
  ...
  ParallelActor = function(_super) {
    ...
    ParallelActor.prototype.start = function() {
      var actor, args, i, _len, _ref, _this = this;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  ...
  AnimationFrameTicker = function() {
    ...
    function AnimationFrameTicker() {
      ...
      if (!AnimationFrameTicker.internal) {
    ...
    AnimationFrameTicker.prototype.removeHandler = function(handler) {
      var index;
      if ((index = this._handlers.indexOf(handler)) !== -1) {
  ...
  Easing = function() {
    ...
    Easing.easeInBounce = function(t, b, c, d) {
      t = 1 - t / d;
      if (t < .36363636363636365) {
        return -c * (7.5625 * t * t - 1) + b;
      } else if (t < .7272727272727273) {
        t -= .5454545454545454;
        return -c * (7.5625 * t * t - .25) + b;
      } else if (t < .9090909090909091) {
        t -= .8181818181818182;
        return -c * (7.5625 * t * t - .0625) + b;
      } else {
        t -= .9545454545454546;
        return -c * (7.5625 * t * t - .015625) + b;
      }
    };
    ...
    Easing.easeInOutBounce = function(t, b, c, d) {
      ...
      if (t < 1) {
        ...
        if (t < .36363636363636365) {
          ...
          t -= .5454545454545454;
          return -c / 2 * (7.5625 * t * t - .25) + b;
        } else if (t < .9090909090909091) {
          t -= .8181818181818182;
          return -c / 2 * (7.5625 * t * t - .0625) + b;
        } else {
          t -= .9545454545454546;
          return -c / 2 * (7.5625 * t * t - .015625) + b;
        }
      } else {
        t -= 1;
        if (t < .36363636363636365) {
    ...
    Easing.easeOutInBounce = function(t, b, c, d) {
      ...
      if (t < 1) {
        if (t < .36363636363636365) {
          ...
          t -= .5454545454545454;
          return c / 2 * (7.5625 * t * t + .75) + b;
        } else if (t < .9090909090909091) {
          t -= .8181818181818182;
          return c / 2 * (7.5625 * t * t + .9375) + b;
        } else {
          t -= .9545454545454546;
          return c / 2 * (7.5625 * t * t + .984375) + b;
        }
      } else {
        t = 2 - t;
        if (t < .36363636363636365) {
